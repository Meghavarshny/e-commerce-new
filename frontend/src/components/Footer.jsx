    ...
    <footer className="bg-gray-900 text-white">
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 text-blue-400">E-Commerce</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/returns" className="text-gray-400 hover:text-white">Return Policy</a></li>
      ...
      <div className="border-t border-gray-800 py-6">
        <div className="mx-auto max-w-7xl px-4 flex flex-col md:flex-row justify-between items-center">
